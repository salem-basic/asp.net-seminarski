...
{
    public class NarudzbaServis : GenericRepository<Narudzba, NarudzbaInsertRequest, object>, INarudzbaService
    {
        private readonly AppDbContext _db;
        IMapper _mapper;

        public NarudzbaServis(AppDbContext db, IMapper mapper) : base (mapper, db)
        {
            _db = db;
            _mapper = mapper;
        }
