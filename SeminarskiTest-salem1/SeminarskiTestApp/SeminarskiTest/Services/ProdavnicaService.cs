...
{
    public class ProdavnicaService : GenericRepository<Prodavnica, ProdavnicaVModel, ProdavnicaSearchObject>, IProdavnicaService
    {
        private readonly AppDbContext _db;

        public ProdavnicaService(AppDbContext db, IMapper mapper) : base(mapper, db)
        {
            _db = db;
        }
