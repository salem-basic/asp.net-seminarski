...
{
    public class EvidencijaZaposlenikaService : GenericRepository<EvidencijaZaposlenika, EvidencijaZaposlenikaVModel, BaseSearchObject>, IEvidencijaZaposlenikaService
    {
        private readonly AppDbContext _db;


        public EvidencijaZaposlenikaService(AppDbContext db, IMapper mapper) : base(mapper, db)
        {
            _db = db;
        }
